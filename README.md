...
Интерфейс двуязычный (русский/английский). Контент — тексты заданий,
разборы, карточки приёмов — переводится отдельно от интерфейса: SQL,
domain и pandas переведены полностью, у model переведены tier 1–3
(45 из 57 заданий), tier 4 в работе. Подробности — в
...
Все четыре трека наполнены, дальнейшая работа — не про пустые ветки графа,
а про углубление и достройку:

- **Английский перевод model-core** — единственный незакрытый кусок контента,
  tier 4 (12 заданий из 57).
