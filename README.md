...
Четыре трека наполнены целиком — **232 задания, 69 навыков**:
...
| Модель данных и BI | 63 | 19 | нет — режим `predict` |

Интерфейс двуязычный (русский/английский), и контент переведён целиком:
все 232 задания, 69 навыков и 69 карточек приёмов существуют на обоих
