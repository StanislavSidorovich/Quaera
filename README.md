...
Разбор трёх сюжетов из этого же датасета, написанный как рабочий документ
аналитика: **[Kaiyo Trading: three findings and what they cost](docs/analysis/kaiyo-trading.en.md)**.
...
| `npm run verify` | Все 10 гейтов: датасет, контент, планировщик, слияние прогресса, график, схема, английская проза, сверка текстом для DAX, миграция хранилища, сверка двух исполнителей |
...
«дописать» и синхронизация прогресса тоже сделаны. Дальнейшая работа
не про пустые ветки графа, а про глубину:
