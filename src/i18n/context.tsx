...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  // <html lang> и <title> объявлены в index.html статически по-английски —
  // по той же причине, по которой initialLocale() отдаёт 'en' незнакомому
  // браузеру. Русскому посетителю их нужно переписать: без синхронизации lang
  // screen reader выбирает произношение и переносы по неверному языку,
  // а вкладка остаётся английской даже после явного переключения на RU —
  // то есть единственная надпись, которую видно, когда приложение свёрнуто.
  //
