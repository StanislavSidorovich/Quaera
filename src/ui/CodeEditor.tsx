  ...
  return (
    <div>
      ...
      <div className="accessory-stack" data-open={tokensOn}>
        ...
        {/*
         * Отдельный ряд, а не хвост ряда символов: одиннадцать чипов в конец
         * того ряда развернули бы его с двух строк на четыре, тогда как своим
         * ряд укладывается в одну (кнопки узкие, см. .accessory.digits).
