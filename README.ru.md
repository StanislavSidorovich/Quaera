...
**Четыре трека — 260 заданий и 72 навыка.** Наполнены целиком, вычитаны
и переведены на английский: интерфейс, задания, карточки приёмов.

| Трек | Заданий | Навыков | Как проверяется ответ |
| --- | --- | --- | --- |
| SQL для аналитика | 83 | 19 | Запрос выполняется в SQLite (sql.js) |
| Аналитика как профессия | 68 | 20 | Выбор варианта с разбором (`predict`) |
